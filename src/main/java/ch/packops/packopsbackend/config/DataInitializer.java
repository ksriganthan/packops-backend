...
public class DataInitializer implements CommandLineRunner {
        ...
        private void generateUsers() {
                ...
                if (isDocker) {
                        System.out.println("Docker profile active: Skipping generation of test users.");
                        return;
                }
        ...
        protected void generateProducts() {
                boolean isDocker = Arrays.asList(env.getActiveProfiles()).contains("docker");
                if (isDocker) {
                        System.out.println("Docker profile active: Skipping generation of dummy products.");
                        return;
                }
                ...
                createProduct("🥔", "from-yellow-500 to-amber-600", 150, 5, snacksCat,
                                ...
                                new Translation("fr", "Chips de pommes de terre",
